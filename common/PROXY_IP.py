...
class PROXY:
    ...
    def Get_db_storage_ip(self):
        ...
        show_database = self.DB.Select_db(select_sql)
...
if __name__ == "__main__":
    ...
    ip_list2 = proxy.Get_ip_list3()
    proxy_list = proxy.Get_effective_ip(ip_list2)
